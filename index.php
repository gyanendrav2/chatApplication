    ...
    <div class="row justify-content-center text-center">
        ...
        <div class="col-md-4">
            <div class="profileimg">
                <img src="https://devilsworkshop.org/files/2013/01/enlarged-facebook-profile-picture.jpg" alt="">
                <?php $username = showing_username($db);
                echo "<h2 class='username'>" . "Welcome ";
                echo " $username";
                echo "</h1>";
                ?>
    ...
    <div class="row justify-content-center h-20">
                ...
                <div class="card-header">
                    <div class="input-group">
                        ...
                        <div class="input-group-prepend">
                            <span class="input-group-text search_btn" data-toggle="tooltip" data-placement="top"
                                  title="Tooltip on top"><i class="fas fa-search"></i></span>
                        </div>
                    </div>
                </div>
                <div class="card-body contacts_body">
                    <ui class="contacts allUserList">
        ...
        <div class="col-md-3  chat">
            <div class="card mb-sm-3 mb-md-0 contacts_card">
                ...
                <div class="card-body contacts_body">
                    <h4 class="text-center requestheading">PENDING REQUEST <span class="numOfRequest"></span></h4>
                    <ui class="contacts friendRequest">

                    </ui>
                    <h4 class="text-center friendListHeading">FRIEND LIST</h4>
                    <ui class="contacts friendList">
        ...
        <div class=" chattingbox  chat addingChatClass">
            <div class="card ">
                <div class="card-header msg_head">
                    <div class="d-flex bd-highlight">
                        <div class="img_cont">
                            <img src="https://cdn4.iconfinder.com/data/icons/ui-standard/96/People-512.png"
                                 class="rounded-circle user_img">
                            <span class="online_icon"></span>
                        </div>
                        <div class="user_info">
                            <span class="withChatingName">Name</span>
                            <span class="withChatingId" style="display:none"></span>
                            <p>1767 Messages</p>
                        </div>
                        <div class="video_cam">
                    ...
                    <span id="action_menu_btn"><i class="fas fa-ellipsis-v profileInfoButton"></i></span>
                ...
                <div class="card-body msg_card_body append-msg-container">
                ...
                <div class="card-footer">
                    <div class="input-group">
                        <div class="input-group-append ">
                            <span class="input-group-text attach_btn"><i class="fas fa-sync-alt refresh"></i></i></span>
                        </div>
                        <textarea name="" class="form-control type_msg" id="msg" placeholder="Type your message..."></textarea>
                        <div class="input-group-append">
                            <span class="input-group-text send_btn append-msg"><i class="fas fa-location-arrow"></i></span>
                        </div>
                    </div>
                </div>
            </div>
